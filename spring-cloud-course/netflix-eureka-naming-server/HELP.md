...
* The original package name 'com.ridao.microservices.netflix-eureka-naming-server' is invalid and this project uses 'com.ridao.microservices.netflixeurekanamingserver' instead.
